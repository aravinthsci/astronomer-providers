...
notebook_task = '{"notebook_path": "/Users/phani.kumar@astronomer.io/Prediction_model_3"}'
...
with DAG(
        dag_id="prediction_analysis_company3",
        start_date=datetime(2022, 1, 1),
        schedule_interval=None,
        catchup=False,
        default_args=default_args,
        schedule=[
            Dataset("databricks://prediction_input_company3"),
        ]
) as dag:
    ...
    opr_submit_run = DatabricksSubmitRunOperator(
        ...
        do_xcom_push=True,
        outlets=[Dataset("s3://prediction_results_company3")]
    )
